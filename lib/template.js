...
Template.prototype.process = function(name, stream){
  chain(
    [
      parse(stream),
      this.applyHandlers(name),
      this.append({ name: stream.path })
    ]
  );
};
...
Template.prototype.applyHandlers = function(name){
